...
public class IfrProdi extends javax.swing.JInternalFrame {
    ...
    private void aksiSimpan(){
        ...
        if(btnSimpan.getText().equals("Simpan")){
            sqlinsert = "insert into tbprodi values ('"+vkd_prodi+"', '"+vkd_jur+"', '"+vprodi+"') ";
        }else{
    ...
    private void aksiHapus(){
        int jawab = JOptionPane.showConfirmDialog(this, 
                    "Apakah Anda yakin akan menghapus data ini? ID. User : "+vkd_prodi, 
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if(cmbJurusan.getSelectedIndex()<=0){
            ...
            JOptionPane.showMessageDialog(this, "Kode Prodi harus Dipilih", "Informasi",
                JOptionPane.INFORMATION_MESSAGE);
        }else if(txtProdi.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Prodi harus Dipilih", "Informasi",
                JOptionPane.INFORMATION_MESSAGE);
        }else{
                aksiSimpan();
        }
